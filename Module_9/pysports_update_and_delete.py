...
try:
    ...
    update_player = ("UPDATE player SET team_id = 2, first_name = 'Jacob', last_name = 'Burrs' WHERE first_name = 'Chris'")

    cursor.execute(update_player)

    show_players(cursor, "DISPLAYING PLAYERS AFTER UPDATE")

    delete_player = ("DELETE FROM player WHERE first_name = 'Jacob'")
